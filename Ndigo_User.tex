...
\definecolor{lbcolor}{rgb}{0.9,0.9,0.9} % background of code listings
...
\addtokomafont{disposition}{\sffamily\color{cronorange}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \usepackage{caption}
    \usepackage{tocloft}
\usepackage[labelfont={color=gray!32},font={color=gray!32,sf}]{caption}
